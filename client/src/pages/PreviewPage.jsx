    ...
    <div className="preview-page">
      <div className="preview-page-header">
        <div>
          ...
          <p>
            Inspect the detected CSV
            structure before configuring
            destination fields,
            transformations, and
            validation.
          </p>
      ...
      <section className="preview-panel">
        ...
        <div className="preview-footer-actions">
          ...
          <button
            ...
            className="primary-button"
            disabled
            title="Column mapping is not available in the current build."
          >
            Continue to mapping
          </button>
        </div>
